...
*/
    public static void main(String[] args) {
        ...
        int rollNum = myScan.nextInt();

        switch (rollNum){
            case 101:
                System.out.println("Student name: Ramesh");break;
            case 102:
                System.out.println("Student name: Mahesh");break;

            case 103:
                System.out.println("Student name: Mukesh");break;
